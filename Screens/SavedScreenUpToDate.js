...
export default function SavedScreenUpToDate() {
    const filterFunction = manhwa => manhwa.reading === 0 && manhwa.chapter.toFixed(1) == manhwa.chapters.toFixed(1) && manhwa.status.trim().toLowerCase() != 'hiatus' && manhwa.category == undefined
